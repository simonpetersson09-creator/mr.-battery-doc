...
export function runBatteryEngine(input: BatteryEngineInput = {}): BatteryEngineResult {
  ...
  const summary: BatteryEngineSummary = {
    ...
    fcr: {
      ...
      avgHeldDownPowerKw: economy.fcr.avgHeldDownPowerKw,
      monthlyGrossSek: economy.fcr.monthlyGrossSek,
    ...
    powerOptions: economicPowerSizing.options.map((o) => ({
      powerKw: o.powerKw,
      cRate: o.cRate,
      actualDispatchPowerKw: o.actualDispatchPowerKw,
      fcrOfferedPowerKw: o.fcrOfferedPowerKw,
      fcrReservablePowerKw: o.fcrReservablePowerKw,
      fcrHeldPowerKw: o.fcrHeldPowerKw,
