...
const EXPECTED = {
  "GM01": {
    ...
    "totalOperatingBenefitSek": 2274.51,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM02": {
  ...
  "GM05": {
    ...
    "importBeforeKWh": 7126.1765,
    "importAfterKWh": 5064.605,
    "exportBeforeKWh": 9126.1765,
    "exportAfterKWh": 6651.4122,
    "shiftedToLoadKWh": 2175.9671,
    "recoveredCurtailmentKWh": 0,
    "cycles": 161.1827,
    "utilisationPct": 44.1597,
    "peakBeforeKw": 5.5338,
    "peakAfterKw": 5.5538,
    "gridStatus": "none",
    "unservedKWh": 0,
    "peakReductionKw": -0.02,
    "demandCostSavingSek": 535.61,
    "fcrEnabled": true,
    "fcrOfferedKw": 1.5,
    "fcrHeldKw": 0.9745,
    "fcrGrossSek": 610.34,
    ...
    "totalOperatingBenefitSek": 2753.45,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM06": {
    ...
    "physicalPowerNeedKw": 2.5,
    "importBeforeKWh": 7126.1765,
    "importAfterKWh": 5106.7918,
    "exportBeforeKWh": 9126.1765,
    "exportAfterKWh": 6692.6522,
    "shiftedToLoadKWh": 2184.2569,
    "recoveredCurtailmentKWh": 0,
    "cycles": 161.7968,
    "utilisationPct": 44.3279,
    "peakBeforeKw": 5.5338,
    "peakAfterKw": 4.4872,
    "gridStatus": "battery-limited",
    "unservedKWh": 0,
    ...
    "totalOperatingBenefitSek": 3080.63,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM07": {
    ...
    "totalOperatingBenefitSek": 2611.23,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM08": {
  ...
  "GM09": {
    ...
    "totalOperatingBenefitSek": 18850.76,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM10": {
    ...
    "totalOperatingBenefitSek": -392.71,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM11": {
    ...
    "totalOperatingBenefitSek": 2391.35,
    "balanceOk": true,
    "residualKWh": 0
  },
  "GM12": {
    ...
    "totalOperatingBenefitSek": 3078.19,
    "balanceOk": true,
    "residualKWh": 0
  }
} as const;
