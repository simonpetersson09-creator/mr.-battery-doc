...
export const en = {
  ...
  paywall: {
    title: "Your battery calculation is ready",
    subtitle: "Unlock the result and your personal battery report.",
    ready: "Calculation complete",
    includesTitle: "You get access to:",
    includes: {
      size: "Recommended battery size and power",
      benefit: "Estimated annual benefit",
      selfSufficiency: "Self-consumption and self-sufficiency before/after",
      peak: "Peak shaving and grid impact",
      ancillary: "Ancillary services calculation",
      investment: "Maximum investment for your payback period",
      pdf: "Complete personal PDF report",
    },
    premium: {
      label: "Premium · 1 year",
      badge: "Best value",
      description: "Unlimited calculations and reports for 1 year.",
      cta: "Start Premium",
    ...
    single: {
      ...
      loadingPrice: "Fetching price…",
      adjustmentsIncluded: "Includes 3 adjustments within 24 h of purchase.",
    },
    ...
    errors: {
      network: "No connection to the App Store. Check your network and try again.",
      products: "We could not load the prices right now.",
      productUnavailable: "The product is temporarily unavailable.",
      verification: "The purchase could not be verified.",
      notSupported: "Purchases are made in the iOS app.",
      unknown: "Something went wrong. Please try again.",
    },
    legal: { terms: "Terms of use", privacy: "Privacy policy" },
    locked: {
      title: "The result is locked",
      description: "Unlock this calculation to see the result and the report.",
      cta: "Go to checkout",
    },
  },
  settings: {
  ...
  history: {
    ...
    adjustmentsLeft: "You have {{count}} adjustments left from your latest purchase.",
    adjustmentsUnlimited: "Unlimited adjustments with Premium.",
