...
export const sv = {
  ...
  economics: {
    ...
    exportPrice: { label: "Såld solel (spotpris)", hint: "Utgå från vad du tror om framtiden." },
    demandCharge: {
      label: "Effektavgift",
      hintDefault:
  ...
  errors: {
    ...
    importNotConfigured: "AI-tjänsten är inte konfigurerad.",
    importRateLimited: "För många förfrågningar just nu. Vänta en stund och försök igen.",
    importCreditsExhausted: "AI-krediterna är slut. Fyll på för att kunna läsa dokument.",
    importUnparsable: "Vi kunde inte tolka innehållet i dokumentet.",
    egValue: "t.ex. {{value}}",
  },
  validation: {
  ...
  paywall: {
    title: "Din batteriberäkning är klar",
    subtitle: "Lås upp resultatet och din personliga batterirapport.",
    ready: "Beräkningen är färdig",
    includesTitle: "Du får tillgång till:",
    includes: {
      size: "Rekommenderad batteristorlek och effekt",
      benefit: "Beräknad årlig nytta",
      selfSufficiency: "Egenanvändning och självförsörjning före/efter",
      peak: "Peak shaving och påverkan på elnätet",
      ancillary: "Beräkning av stödtjänster",
      investment: "Maxinvestering utifrån vald återbetalningstid",
      pdf: "Komplett personlig PDF-rapport",
    },
    premium: {
      label: "Premium · 1 år",
      badge: "Bäst värde",
      description: "Obegränsade beräkningar och rapporter i 1 år.",
      cta: "Starta Premium",
      value: "Premium lönar sig från 5 rapporter per år.",
      renewal:
        "{{price}}. Prenumerationen förnyas automatiskt om den inte avslutas enligt App Stores villkor.",
      loadingPrice: "Hämtar pris…",
    },
    single: {
      label: "En rapport",
      description: "Lås upp den här beräkningen och PDF-rapporten.",
    ...
    errors: {
      network: "Ingen kontakt med App Store. Kontrollera nätverket och försök igen.",
      products: "Vi kunde inte hämta priserna just nu.",
      productUnavailable: "Produkten är tillfälligt otillgänglig.",
      verification: "Köpet kunde inte verifieras.",
      notSupported: "Köp görs i iOS-appen.",
      unknown: "Något gick fel. Försök igen.",
    },
    legal: { terms: "Användarvillkor", privacy: "Integritetspolicy" },
    locked: {
      title: "Resultatet är låst",
      description: "Lås upp den här beräkningen för att se resultatet och rapporten.",
      cta: "Till betalvägg",
    },
  },
  settings: {
