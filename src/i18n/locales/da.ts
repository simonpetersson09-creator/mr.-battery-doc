...
export const da = {
  ...
  economics: {
    ...
    exportPrice: { label: "Solgt solstrøm (spotpris)", hint: "Tag udgangspunkt i din forventning." },
    demandCharge: {
  ...
  paywall: {
    ...
    single: {
      ...
      loadingPrice: "Henter pris…",
      adjustmentsIncluded: "Inkluderer 3 justeringer inden for 24 t fra køb.",
    },
