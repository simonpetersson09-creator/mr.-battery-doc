      ...
      <main className="pt-safe flex-1 px-4 pb-4">
        ...
        >
          ...
          <Button
            ...
            // Never disabled for a missing price: a dead-looking button fails App
            // Review. A tap retries the store lookup and always answers visibly.
